#! workflow_script.search_and_destroy__pycache__.py
...
def _enumerate_search_keyword_over_path(
    ...
    print(
        "\033[91m\033[1m {}\033[0m directories were identified containing keyword: \033[91m\033[1m{}\033[0m".format(
            str(len(matching_dirpath)), keyword
        )
    )
