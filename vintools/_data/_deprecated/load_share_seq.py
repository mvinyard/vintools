...
def load_share_seq(save_destination="./", keep_local_copy=True):
    ...
    data_path = "gs://transfer-mev/share_seq.h5ad"
    adata = utils.load_adata_from_GCP_bucket(
        data_path, save_destination, keep_local_copy
    )
    print(adata)
