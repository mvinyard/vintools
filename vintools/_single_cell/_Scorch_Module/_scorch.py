from ._scorch_supporting_functions import (
    _get_sample_name,
    _scanpy_filter,
    _run_scanpy_standard_qc,
    _scanpy_normalize,
    ...
    _plot_UMAP_by_GEX,
    _adjust_clustering_resolution,
    _scanpy_dotplots_GEX,
)
...
class Scorch:
    ...
    def adjust_clustering_resolution(
        self,
        algorithm="both",
    ...
    def cluster_dotplot(self, marker_genes=None, clustering_algorith="leiden"):
        ...
        _scanpy_dotplots_GEX(
            self.adata, marker_genes, clustering_algorithm=clustering_algorith
        )
